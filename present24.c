...
int encrypt_print(int mot, int cle_maitre)
{
...
int encrypt(int mot, int cle_maitre)
{
	int etat = mot;
	algo_cadencement(cle_maitre);
...
int decrypt_print(int mot_chiffre, int clef_maitre)
{
...
int decrypt(int mot_chiffre, int clef_maitre)
{
	int etat = mot_chiffre;
	algo_cadencement_2(clef_maitre);
