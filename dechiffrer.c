...
// variables globales :
int t1[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf};	// S(x)
int t2[] = {0x5, 0xe, 0xf, 0x8, 0xc, 0x1, 0x2, 0xd, 0xb, 0x4, 0x6, 0x3, 0x0, 0x7, 0x9, 0xa};	// x

int P[] = {0, 4, 8 ,12, 16, 20, 1, 5, 9, 13, 17, 21, 2, 6, 10, 14, 
 			18, 22, 3, 7, 11, 15, 19, 23};													// P(i) -> i
...
int permutation_inv(int n)
{
	...
	resultat = calcul_binaire_en_hexa(nouveau);
	free(nouveau);
	return resultat;
}
